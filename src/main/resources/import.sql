...
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'Stanley', 'Kubrick','1928-07-26');
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'Ethan', 'Coen','1957-09-21');
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'John Lee', 'Hancock','1956-12-15');
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'Chris', 'Columbus','1958-09-10');
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'Franklin J.', 'Schaffner', '1920-05-30');
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'Gabriele', 'Mainetti','1976-07-11');
insert into artist (id, name, surname, birthday) values(nextval('artist_seq'), 'Danny', 'Boyle','1956-10-20');